# HGETtrack
The official fine-tuning implementation of HGETtrack for the **CVPR 2023** paper [_DropMAE: Masked Autoencoders with Spatial-Attention Dropout for Tracking Tasks_](https://arxiv.org/pdf/2304.00571.pdf).
...
|:-----------:|:------------:|:-----------:|:-----------:|:-----------------:|:-----------:|
| HGETtrack-K700-ViTBase | 75.9         | 71.8        | 52.7        | 84.1              | 56.9        |


### :star2: Training Speed
Our HGETtrack has the same training procedure and nearly the same model parameters (i.e., except for using two frame identity embeddings) w/ OSTrack, so the training speed is consistent w/ OSTrack. We use 4 A100 GPUs w/ a total batch size of 128, which costs about ~6 hours (100 Epochs) for training on GOT-10k.
...
```
conda create -n hgettrack python=3.8
conda activate hgettrack
...
## Training logs
The training log of HGETtrack-Got10k-100E is available [here](https://github.com/jimmy-dq/DropTrack/blob/main/hgettrack-vitb_384_mae_ce_32x4_got10k_ep100.log).
