...
def run_sequence(seq_name, seq_home, dataset_name, yaml_name, num_gpu=1, epoch=300, debug=0, script_name='ostrack'):
    ...
    if script_name == 'ostrack':
        ...
        checkpoint_dir = '/root/autodl-tmp/HGETtrack-main/output/checkpoints/train/ostrack/vitb_384_mae_ce_32x4_got10k_ep100'
        params.checkpoint = os.path.join(checkpoint_dir, 'best.pth.tar')
